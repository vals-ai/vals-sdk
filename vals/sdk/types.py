...
class OutputObject(BaseModel):
    ...
    duration: float | None = None  # Optional: Generation time in seconds
    in_tokens: int | None = None  # Optional: Input token count
    out_tokens: int | None = None  # Optional: Output token count
